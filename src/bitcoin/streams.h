...
public:
     ...
     */
    GenericVectorWriter(int nTypeIn, int nVersionIn, ByteVectorT &dataIn, size_type nPosIn)
    ...
    GenericVectorWriter(int nTypeIn, int nVersionIn, ByteVectorT & dataIn, size_type nPosIn, Args &&... args)
...
public:
     ...
     */
    GenericVectorReader(int type, int version, const ByteVectorT &data, size_type pos)
     ...
     */
    template <typename... Args>
    GenericVectorReader(int type, int version, const ByteVectorT &data, size_type pos, Args &&... args)
