...
#else
// Added by Calin: a "fake" implementation that throws. This is ok since we don't actually use the functions.
...
#define THROW_UNIMPLEMENTED throw std::runtime_error(fmt::format("{} is not compiled-in on this platform", __func__))
