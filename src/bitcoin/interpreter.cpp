                ...
                switch (opcode) {
                    ...
                    case OP_NOP10: {
                        if (flags & SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_NOPS) {
                            return set_error(
                                serror, ScriptError::DISCOURAGE_UPGRADABLE_NOPS);
                        }
                    } break;
                    ...
                    case OP_CHECKMULTISIGVERIFY: {
                        ...
                        int64_t const nKeysCount = CScriptNum(stacktop(-idxKeyCount), fRequireMinimal/*, maxIntegerSize*/).getint/*64*/();
                        ...
                        int64_t const nSigsCount = CScriptNum(stacktop(-idxSigCount), fRequireMinimal/*, maxIntegerSize*/).getint/*64*/();
                        ...
                        if ((flags & SCRIPT_ENABLE_SCHNORR_MULTISIG) &&
                            ...
                            // Added here by Calin. This really lives in  bitfield.cpp in BCHN
                            static const auto DecodeBitfield = [] (const std::vector<uint8_t> &vch, unsigned size,
                            ...
                            static auto countBits = [](uint32_t v) -> uint32_t {
