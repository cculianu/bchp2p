...
public:
     ...
     * @note Passing in a `command` longer than COMMAND_SIZE will result in a
     * run-time assertion error.
     */
    CMessageHeader(const MessageMagic &pchMessageStartIn, std::string_view command, unsigned int nMessageSizeIn);

    // Construct a fully valid header given a magic and a serialized net message
    CMessageHeader(const MessageMagic &pchMessageStartIn, const CSerializedNetMsg &msg);

    std::string GetCommand() const;
    bool IsValid(const MessageMagic &magic) const;
 ...
 */
extern const std::string_view VERACK;
/**
 * The addr (IP address) message relays connection information for peers on the
 * network.
 * @see https://bitcoin.org/en/developer-reference#addr
 */
extern const std::string_view ADDR;
/**
 * The addrv2 message relays connection information for peers on the network just
 * like the addr message, but is extended to allow gossiping of longer node
 * addresses (see BIP155).
 */
extern const std::string_view ADDRV2;
/**
 * The sendaddrv2 message signals support for receiving ADDRV2 messages (BIP155).
 * It also implies that its sender can encode as ADDRV2 and would send ADDRV2
 * instead of ADDR to a peer that has signaled ADDRV2 support by sending SENDADDRV2.
 */
extern const std::string_view SENDADDRV2;
/**
 * The inv message (inventory message) transmits one or more inventories of
 * objects known to the transmitting peer.
 * @see https://bitcoin.org/en/developer-reference#inv
 */
extern const std::string_view INV;
/**
 * The getdata message requests one or more data objects from another node.
 * @see https://bitcoin.org/en/developer-reference#getdata
 */
extern const std::string_view GETDATA;
/**
 ...
 */
extern const std::string_view MERKLEBLOCK;
/**
 * The getblocks message requests an inv message that provides block header
 * hashes starting from a particular point in the block chain.
 * @see https://bitcoin.org/en/developer-reference#getblocks
 */
extern const std::string_view GETBLOCKS;
/**
 ...
 */
extern const std::string_view GETHEADERS;
/**
 * The tx message transmits a single transaction.
 * @see https://bitcoin.org/en/developer-reference#tx
 */
extern const std::string_view TX;
/**
 ...
 */
extern const std::string_view HEADERS;
/**
 * The block message transmits a single serialized block.
 * @see https://bitcoin.org/en/developer-reference#block
 */
extern const std::string_view BLOCK;
/**
 * The getaddr message requests an addr message from the receiving node,
 * preferably one with lots of IP addresses of other receiving nodes.
 * @see https://bitcoin.org/en/developer-reference#getaddr
 */
extern const std::string_view GETADDR;
/**
 ...
 */
extern const std::string_view MEMPOOL;
/**
 * The ping message is sent periodically to help confirm that the receiving
 * peer is still connected.
 * @see https://bitcoin.org/en/developer-reference#ping
 */
extern const std::string_view PING;
/**
 ...
 */
extern const std::string_view PONG;
/**
 ...
 */
extern const std::string_view FILTERLOAD;
/**
 ...
 */
extern const std::string_view FILTERADD;
/**
 ...
 */
extern const std::string_view FILTERCLEAR;
/**
 ...
 */
extern const std::string_view REJECT;
/**
 ...
 */
extern const std::string_view SENDHEADERS;
/**
 * The feefilter message tells the receiving peer not to inv us any txs
 * which do not meet the specified min fee rate.
 * @since protocol version 70013 as described by BIP133
 */
extern const std::string_view FEEFILTER;
/**
 ...
 */
extern const std::string_view SENDCMPCT;
/**
 * Contains a CBlockHeaderAndShortTxIDs object - providing a header and
 * list of "short txids".
 * @since protocol version 70014 as described by BIP 152
 */
extern const std::string_view CMPCTBLOCK;
/**
 * Contains a BlockTransactionsRequest
 * Peer should respond with "blocktxn" message.
 * @since protocol version 70014 as described by BIP 152
 */
extern const std::string_view GETBLOCKTXN;
/**
 * Contains a BlockTransactions.
 * Sent in response to a "getblocktxn" message.
 * @since protocol version 70014 as described by BIP 152
 */
extern const std::string_view BLOCKTXN;
/**
 ...
 */
extern const std::string_view EXTVERSION;
/**
 * Double spend proof
 */
...
// Taken from netmessagemaker.h
class CNetMsgMaker {
public:
    explicit CNetMsgMaker(int nVersionIn) : nVersion(nVersionIn) {}

    template <typename... Args>
    CSerializedNetMsg Make(int nFlags, std::string_view msg_type, Args &&... args) const {
    ...
    template <typename... Args>
    CSerializedNetMsg Make(std::string_view msg_type, Args &&... args) const {
...
/** "reject" message codes; Taken from validation.h */
