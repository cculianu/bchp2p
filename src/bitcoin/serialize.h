...
/**
 * string_view (serialize only)
 */
template <typename Stream, typename C>
void Serialize(Stream &os, std::basic_string_view<C> str);
...
void SerializeMany(Stream &s, const Arg &arg, const Args &... args) {
    bitcoin::Serialize(s, arg);
    bitcoin::SerializeMany(s, args...);
}
...
inline void UnserializeMany(Stream &s, Arg &&arg, Args &&... args) {
    bitcoin::Unserialize(s, arg);
    bitcoin::UnserializeMany(s, args...);
}
